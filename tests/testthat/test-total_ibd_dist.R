...
test_that("total_ibd_dist point masses agree with cibd_density", {
  ...
  for (pedigree in pedigrees){
    ...
    p_cibd <-  cibd_density(cM = L, ibd = 0, pedigree = pedigree)
    ...
    p1_cibd <- cibd_density(cM = L, ibd = 1, pedigree = pedigree)
